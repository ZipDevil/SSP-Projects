This repo houses two projects for the end of SSP. We'll be diving into how a JavaScript file works with HTML and CSS file to create an interactive web application.
